            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        <a href="published.html" class="nav-item nav-link">Publisshed</a>
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <img class="position-relative rounded w-100 h-100" src="img/s6.jpg"
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <div type="text" class="form-control" style="background-color: #90f9d36c;
                                              border: 2px solid #00B98E;
                                            box-shadow: 0 0 10px #00B98E ;">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            ...
                                            border: 2px solid #00B98E;
                                          box-shadow: 0 0 10px #00B98E ;">
                                                <p for="name">Number Of Employee</p>
                                                </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <div type="text" class="form-control" style="height: 160px;background-color: #90f9d36c;
                                            border: 2px solid #00B98E;
                                          box-shadow: 0 0 10px #00B98E ;">
                                                <p for="name">Bio</p>
                                                </div>
